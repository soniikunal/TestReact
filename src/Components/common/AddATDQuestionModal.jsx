...
import { AddATDQuestion, GetCategories } from '../../config/apiConfig.js'
import TinyMCEEditor from './TinyMCEEditor.jsx';


const AddATDQuestionModal = () => {
    ...
    const handleAddQuestion = async () => {
        ...
        try {
            const result = await AddATDQuestion(formData)
...
export default AddATDQuestionModal
